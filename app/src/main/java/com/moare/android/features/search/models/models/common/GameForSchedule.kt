...
data class GameForSchedule<T>(
    @SerialName("itemKey")
    private val _itemKey: String? = null,

    @SerialName("homeTeamId")
    private val _homeTeamId: Int? = null,

    @SerialName("awayTeamId")
    private val _awayTeamId: Int? = null,

    @SerialName("homeTeamScore")
    private val _homeTeamScore: Int? = null,

    @SerialName("awayTeamScore")
    private val _awayTeamScore: Int? = null,

    @SerialName("gameStatus")
    private val _gameStatus: String? = null,
